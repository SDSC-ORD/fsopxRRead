...
test_that("scan px cube file: 2184.px", {
  ...
  expected_metadata <- jsonlite::fromJSON(paste0(expected_output_dir, "metadata.json"))
...
test_that("scan px cube file: px-x-0102020203_110 and localize to English", {
  ...
  test_output_dir <- here::here("tests/testthat/output/test-output/")
  expected_output_dir <- here::here("tests/testthat/output/px-x-0102020203_110/")
  expected_metadata_en <- jsonlite::fromJSON(paste0(expected_output_dir, "metadata-en.json"))
  expected_metadata_default <- jsonlite::fromJSON(paste0(expected_output_dir, "metadata.json"))
  expected_data <- read.csv(paste0(expected_output_dir, "data-en.csv"))
  expected_translation_en <-jsonlite::fromJSON(paste0(expected_output_dir, "en.json"))
  expected_translation_it <- jsonlite::fromJSON(paste0(expected_output_dir, "it.json"))
  expected_translation_fr <- jsonlite::fromJSON(paste0(expected_output_dir, "fr.json"))
  ...
  actual_path_translation_en <- paste0(test_output_dir, "en.json")
  actual_path_translation_it <- paste0(test_output_dir, "it.json")
  actual_path_translation_fr <- paste0(test_output_dir, "fr.json")
  ...
  actual_translation_en <- jsonlite::fromJSON(actual_path_translation_en)
  actual_translation_fr <- jsonlite::fromJSON(actual_path_translation_fr)
  actual_translation_it <- jsonlite::fromJSON(actual_path_translation_it)
  actual_data <- read.csv(actual_path_data)
  expect_equal(identical(expected_metadata_en, actual_metadata_en), TRUE)
  expect_equal(identical(expected_metadata_default, actual_metadata_default), TRUE)
  expect_equal(identical(expected_data, actual_data), TRUE)
  expect_equal(identical(expected_translation_en, actual_translation_en), TRUE)
  expect_equal(identical(expected_translation_fr, actual_translation_fr), TRUE)
  expect_equal(identical(expected_translation_it, actual_translation_it), TRUE)
  file.remove(actual_path_metadata_en)
  file.remove(actual_path_metadata_default)
  file.remove(actual_path_data)
  file.remove(actual_path_translation_en)
  file.remove(actual_path_translation_fr)
  file.remove(actual_path_translation_it)
})
...
test_that("scan px cube file: px-x-0602000000_107 and localize to English", {
  ...
  test_output_dir <- here::here("tests/testthat/output/test-output/")
  expected_output_dir <- here::here("tests/testthat/output/px-x-0602000000_107/")
  expected_metadata_en <- jsonlite::fromJSON(paste0(expected_output_dir, "metadata-en.json"))
  expected_metadata_default <- jsonlite::fromJSON(paste0(expected_output_dir, "metadata.json"))
  expected_data <- read.csv(paste0(expected_output_dir, "data-en.csv"))
  expected_translation_en <-jsonlite::fromJSON(paste0(expected_output_dir, "en.json"))
...
test_that("scan px cube file: px-x-1003020000_201 and localize to English", {
  ...
  test_output_dir <- here::here("tests/testthat/output/test-output/")
  expected_output_dir <- here::here("tests/testthat/output/px-x-1003020000_201/")
  expected_metadata_en <- jsonlite::fromJSON(paste0(expected_output_dir, "metadata-en.json"))
  expected_metadata_default <- jsonlite::fromJSON(paste0(expected_output_dir, "metadata.json"))
  expected_data <- read.csv(paste0(expected_output_dir, "data-en.csv"))
  expected_translation_en <-jsonlite::fromJSON(paste0(expected_output_dir, "en.json"))
